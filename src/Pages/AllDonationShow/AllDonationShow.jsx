...
const AllDonationShow = () => {
  ...
  return (
    <div>
      ...
      <ul className="grid grid-cols-1 w-full md:grid-cols-2 ">
        {displayDonations.map((donation) => (
          <li key={donation.id} >
            <span  >
              <div >
                <div style={{ backgroundColor: donation.card_bg }} className="relative flex w-full max-w-[45rem] gap-6   my-3  rounded-xl   text-gray-700 shadow-md">
